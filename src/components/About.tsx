function About() {
  return (
    <>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:px-14 px-1">
        ...
        <div className="border-2 p-5 space-y-4 rounded-lg shadow-lg">
          ...
          Hi, I’m Muhammad Suleman, a MERN stack developer proficient in building end-to-end web applications using MongoDB, Express.js, React, and Node.js. I specialize in creating modular front-end interfaces with efficient state management and scalable back-end architectures featuring RESTful APIs, authentication, and database design. With strong debugging skills and API optimization experience, I deliver secure, high-performance solutions. Known for clean code practices and effective collaboration, I continuously explore modern tools to align development with business goals and user needs.
          </p>
        </div>
          ...
          <div className="border-l-4 border-sky-400 pl-4">
            <ul className="space-y-6">
              <div> 
                ...
                <span>- Karachi University | 2023 - 2026 (Expected)</span>
                </div>    
              <div>
              <p className="font-bold">Full Stack Development Cohort </p>
              <span>- 100xDev Cohort | Jan 2024 - Apr 2025</span>
                </div>    
            </ul>
          </div>
          </div>
        ...
        <div className="right-div border-2 p-5 space-y-4 rounded-lg shadow-lg">
          ...
          <div className="border-l-4 border-sky-400 pl-4 space-y-4">
            ...
            <p>Aptech | February 2024 – July 2024</p>
            </div>
