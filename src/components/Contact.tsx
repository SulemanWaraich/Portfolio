...
function Contact() {
  ...
  return (
    <div className="w-screen min-h-screen p-5 overflow-x-hidden">
      ...
      <form className="flex flex-col justify-start mx-auto lg:w-3/6 md:w-4/6 w-11/12 items-start p-10 rounded-lg space-y-5 bg-white shadow-xl md:h-[80vh] overflow-y-auto border-2" onSubmit={handleSubmit(onSubmit)}>
